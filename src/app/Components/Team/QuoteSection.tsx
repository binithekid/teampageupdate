...
const quoteContent = [
  ...
  `<b>building</b><span class="team_quote_icon">${teamQuoteBridging}</span>&nbsp;and growing a leading`,
  `<b> portfolio of sustainable</b>`,
  `<b> digital infrastructure</b>"`,
];
  ...
  const quoteScene = (gsapCtx: any) => {
    gsapCtx = gsap.context(() => {
      ...
      const startReveilingIcons =
        quoteContainerHeight * 0.6 - window.innerHeight * 0.9;
      const allQuoteIcons = quoteContentWrapper.current.querySelectorAll(
        "span.team_quote_icon"
      );
