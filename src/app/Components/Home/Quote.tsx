...
import { quoteBuilding, quoteGeneration, quoteGlobal, quoteImprove, quoteProductivity, quoteUpgrading } from "../../utils/svgAsssets"
  ...
  const quoteScene = ( CTX: any ) => {
    CTX = gsap.context(() => {
      ...
      gsap.fromTo(contentElements, {
        yPercent: 110, rotateX: -70, alpha: 0, skewY: -2
      },{
        yPercent: 0,
        rotateX: 0,
        alpha: 1,
      ...
      const allQuoteIcons       = quoteContentWrapper.current?.querySelectorAll("span.quote_icon")
