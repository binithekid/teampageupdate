...
export const StrategySection = () => {
  ...
  const [headingContent, setHeadingContent] = useState<any>(
    "Digital Gravity’s investment strategy"
  );
  ...
  const strategySceneAnimation = (gsapCtx: any) => {
    gsapCtx = gsap.context(() => {
      ...
      const allCharElements = ElementSeparator(
        strategyHeadlineRef.current,
        "span"
      );
      ...
      setTimeout(() => {
        ...
        const allSeparatedElements =
          strategyHeadlineRef.current.querySelectorAll("span");
        ...
        const scrollWidth =
          strategyHeadlineRef.current.offsetWidth - window.innerWidth * 0.75;
  ...
  return (
    <section
      className={`${styles.strategy_section} container`}
      ref={strategySectionRef}
    >
      <h4 ref={strategyHeadingContainerRef}>
        <span
          className={styles.heading_chars_container}
          ref={strategyHeadlineRef}
