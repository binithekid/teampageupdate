...
export const metadata = {
  ...
  description: 'Digital Gravity is a specialist digital infrastructure investment manager building platforms to deliver sustainable connectivity generations',
}
      ...
      <body className={`no-scroll ${myFont.className}`}>
        ...
        {/* <div className="page_wrapper" > */}
          ...
          <div className="page_transition_wrapper">
            ...
            <svg id="PageTransition" width="100%" height="100%" viewBox="0 0 100 100" preserveAspectRatio="none">
